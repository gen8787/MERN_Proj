...
//==   S T A T E   ==||
    ...
    var getElevation = MapboxElevation('pk.eyJ1IjoiZ2VuODc4NyIsImEiOiJja2Q2bXA4cHMxYXN0MndrY2E1aHg1dWM4In0.4b6zrIoo4plHMfwHEAgA5w');
                ...
                <TableBody>
                {
                    lines.map((line, i) => 
                        <TableRow key={i+1}>
                            ...
                            <TableCell>{ ele[i+1] - ele[i] }</TableCell>
                            {/* {
                                (i == 0) ? <TableCell>{ ele }</TableCell>
